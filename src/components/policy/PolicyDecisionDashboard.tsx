    ...
    <div className="space-y-6 text-left">
      ...
      <div className="flex items-center gap-2 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 max-w-fit border border-slate-200 dark:border-slate-700">
        ...
        >
          ...
          <span>Policy Repository & Area Directives</span>
        </button>
        ...
        >
          ...
          <span>Strategic Decision Alerts & Hotspots</span>
        </button>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-brand-600 text-white font-semibold hover:bg-brand-700 shadow-xs cursor-pointer"
            >
