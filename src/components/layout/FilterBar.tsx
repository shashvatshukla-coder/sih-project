...
import { Filter, RotateCcw, MapPin, Calendar, Layers, ChevronDown } from 'lucide-react';
...
export const FilterBar: React.FC = () => {
  ...
  const categories: Array<{ id: LandCategory; label: string; color: string }> = [
    ...
    { id: 'barren', label: 'Barren & Uncultivable', color: 'text-amber-700 bg-amber-50 border-amber-200' },
